...
//
///**
// *  结合resources/tempate中模板运行此方法生成mybatis代码
// *  生成代码自动放入对应目录
// * @author 热水
// * @create 2020/5/2
// */
...
//    // 数据库连结信息
//    private final String dbUrl = "jdbc:mysql://localhost:9306/ebytecloud?useUnicode=true&characterEncoding=UTF8&serverTimezone=Asia/Shanghai&useSSL=false&autoReconnect=true&autoReconnectForPools=true&allowMultiQueries=true";
...
//    private final String  workSpacePath = "D:\\mybatisCode\\";
//    // 项目名, 可以采用父子项目的配法eByteCloud//eByteCoud-Auth，如果无子项目，则直接写项目名称，例如：eByteCloud
//    private final String projectName = "eByteCloud\\eByteCoud-Auth";
//    // 指定包名,即controll,service,entity,mapper子包的父包
//    private final String packageName = "com.surong.auth";
//    // 模块名，则需在模块名前加. 例：.auth, 一般不加，它是在生成的controll,service,entity包后面再加子包
//    private final String moduleName = "";
//    // 作者名
//    private final String author = "zhongzk";
//    // 指定生成的表名多个表之间用逗号,如果要生成所有表，可以不需要配置，执行generateCode中的方案二
//    private final String[] tableNames = new String[]{"sr_sys_user","sr_sys_role"};
//
//
//    @Test
...
//       // return "D:\\develop\\code\\" + projectName + "/src/main/java/";
...
//                .setTablePrefix(new String[]{"sr_"})
//                //从数据库表到文件的命名策略，数据库下划线命名转为java代码中驼峰命名
//                .setNaming(NamingStrategy.underline_to_camel)
//                // 需要生成的表,多个英文逗号分割,不加则全部生成 zhongzk,也可以.setInclude(new String[] {"sr_sys_user, "sr_sys_role"})
